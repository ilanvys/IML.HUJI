...
from house_price_prediction import preprocess_data
import pandas as pd
from typing import Tuple
...
def test_preprocess_irrelevant_cols_deleted():
    irrelevant_cols = {'id', 'date', 'lat', 'long'}  # Change according to your implementation
    # Arrange
...
def test_preprocess_bad_rows_tiny_rooms():
    ...
    minimum_size_in_sqft = 10  # Change according to your implementation #SIZE
    X, y = create_dummy_house_dataframe(
...
if __name__ == '__main__':
    ...
    # test_preprocess_hard_null_check()  # Irrelevant
    ...
    # test_preprocess_date_should_be_numerical()  # Irrelevant
